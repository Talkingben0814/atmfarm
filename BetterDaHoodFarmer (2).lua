...
getgenv().farmerSettings = {
	DiscordWebhook = "https://discord.com/api/webhooks/1218289873581244596/eXfZJxNAO-xa0xvGFYKZfqaLPvw8rE_pki4EnRpY_e56s9MoZWDZSN8hGMNULBrBnBI6", -- Put your Discord webhook here
	UpdateIntervals = 1, -- Number of minutes to wait before sending a farm update to Discord channel
}
